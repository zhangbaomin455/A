        ...
        <div class="pro-s-box thin-bor-bottom" id="divSearch">
            <div class="box">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="输入“汽车”试试"  name="goods_name" id="txtSearch" />
        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    <li sortid='0' cate_id="0" class='cateId current'><span class='items'>全部商品</span></li>
                    @foreach($cate as $v)
            ...
            <div class="good-list-wrapper">
                <div class="good-menu thin-bor-bottom">
                    <ul class="good-menu-list" id="ulOrderBy">
                        <li orderflag="50" type="update_time" class="current"><a href="javascript:;">最新</a></li>
                        <li orderflag="20"  type="goods_num"><a href="javascript:;">库存<span>↑</span></a></li>
                        <li orderflag="30"  type="self_price"><a href="javascript:;">价值<span>↑</span></a></li>
                        <!--价值(由高到低30,由低到高31)-->
                    </ul>
                </div>
                <div id="box">
...
<script>
    ...
    /**下导航栏显示颜色 */
    $("#f_announced").addClass('hover');
    $("#f_announced").parent('li').siblings('li').children('a').removeClass('hover');
    ...
    $(document).on('click','#ulOrderBy li',function(){
         //当前点击获取红色
       ...
       // console.log(_type)
        ...
        $.ajax({
            type:'post',
            url:"{{url('sortshop')}}",
            data:{_type:_type,_token:_token,cate_id:cate_id,top:top}
        }).done(function (res) {
            $("#box").html(res);
            if(top=='↑'){
